...
const actions = [
  { label: "Log a meal", detail: "Foods, servings and macros", tab: "meal", icon: Utensils, color: "bg-[#fff1ef] text-coral" },
  { label: "Log a workout", detail: "Exercises, sets and duration", tab: "workout", icon: Dumbbell, color: "bg-[#eeeaff] text-violet" },
  { label: "Log sleep", detail: "Duration and recovery quality", tab: "sleep", icon: Moon, color: "bg-[#f1edff] text-violet" },
  { label: "Log body measurement", detail: "Weight and measurements", tab: "body", icon: Scale, color: "bg-[#e9ffef] text-green" },
];
