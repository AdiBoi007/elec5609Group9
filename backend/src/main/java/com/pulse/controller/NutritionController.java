...
public class NutritionController {
    ...
    @PostMapping("/targets") Map<String, Object> targets(@Valid @RequestBody TargetRequest request) { return calculator.calculate(request.age(), request.gender(), request.heightCm(), request.weightKg(), request.activityLevel(), FitnessGoal.from(request.goal())); }
