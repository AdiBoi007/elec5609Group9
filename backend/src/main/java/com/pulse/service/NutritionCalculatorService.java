...
public class NutritionCalculatorService {
    public Map<String, Object> calculate(int age, String gender, double heightCm, double weightKg, String activityLevel, String goal) {
        ...
        String normalizedGoal = goal.toLowerCase().replace(' ', '_');
        int calories = tdee + (("build_muscle".equals(normalizedGoal) || "gain_weight".equals(normalizedGoal)) ? 250 : "lose_weight".equals(normalizedGoal) ? -400 : 0);
